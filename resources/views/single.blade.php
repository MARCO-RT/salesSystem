	...
	<div class="single-page main-grid-border">
		<div class="container">
			<ol class="breadcrumb" style="margin-bottom: 5px;">
				<li><a href="/">Home</a></li>
				<li><a href="/categories/">All Ads</a></li>
				<li class="active"><a href="{{url('/')}}/categories/{{$product->slug}}">{{$product->type}}</a></li>
				<li class="active">{{$product->name}}</li>
			</ol>
			<div class="product-desc">
				<div class="col-md-7 product-view">
					<h2>Lorem Ipsum is simply dummy text of the printing and typesetting industry</h2>
					<p> <i class="glyphicon glyphicon-map-marker"></i><a href="#">state</a>, <a href="#">city</a>| Added {{$product->creado}}, Ad ID: {{$product->code}}</p>
					<div class="flexslider">

							{{--@foreach($resultFinal as $allImages)--}}
							{{--<li data-thumb="{{ $allImages->url_i}}">--}}
								{{--<img src="{{ $allImages->url_i}}" />--}}
							{{--</li>--}}
								{{--@endforeach--}}
							<ul class="slides">
								@foreach($resultFinal as $allImages)
								<li data-thumb="{{url('/')}}/{{ $allImages->url_i}}">
									<img src="{{url('/')}}/{{ $allImages->url_i}}" />
								</li>
								@endforeach
